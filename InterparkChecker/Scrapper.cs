...
namespace InterparkChecker
{
    public class Scrapper
    {
        ...
        public static string Scraping(string url, Method method, List<Querystring> paramList)
        {
            ...
            try
            {
               ...
               // wReq.Timeout = 30 * 1000;
                //wReq.Referer = "http://forest.maketicket.co.kr/ticket/GD84";
                //wReq.Headers.Add(""); // 헤더추가
    ...
    public enum Method { GET = 1, PORT = 2 }
